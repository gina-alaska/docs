...
The url for this service is _"http://wms.alaskamapped.org/extras?"_ .  Here is a link to the "capabilities document":http://wms.alaskamapped.org/cgi-bin/bdl_extras.cgi?SERVICE=WMS&VERSION=1.1.1&REQUEST=GetCapabilities .
